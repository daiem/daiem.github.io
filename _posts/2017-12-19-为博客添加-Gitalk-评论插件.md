...
subtitle:   EM Blog 添加 Gitalk 的评论插件了
date:       2017-12-19
author:     EM
...
当然，你也可以手动创建issue作为 gitalk评论容器。只要有 `Gitalk` 标签 和 `id` 对应标签就可以。比我我自己创建的 [About issue](https://github.com/daiem/daiem.github.io/issues/38) 。
...
最后，[给个 star 吧](https://github.com/daiem/daiem.github.io)~